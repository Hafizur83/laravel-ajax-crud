...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h5 id="addform">Add New Catagory</h5>
                    <h5 id="upform">Update Catagory</h5>
                </div>
                <div class="card-body">
                    <form id="dataform">
                        @csrf
                  <div class="form-group">
                    ...
                    <span class="text-danger" id="cat_name_err"></span>
                  </div>
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                $.each(response,function(key, value){
                    ...
                    html = html + "<td> "+ value.cat_name + "</td>"
    ...
    function reset(){
        ...
        $.ajax({
            ...
            error: function(error){
                $('#cat_name_err').text(error.responseJSON.errors.cat_name)
                console.log(error.responseJSON.errors.cat_name)
            }
        })
    })
